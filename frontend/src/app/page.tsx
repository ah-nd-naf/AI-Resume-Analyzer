  ...
  return (
    <main className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 font-sans selection:bg-indigo-100 selection:text-indigo-900">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        {/* Main Interface Card */}
        <div className="bg-white rounded-3xl shadow-xl ring-1 ring-slate-900/5 p-6 sm:p-10">
          
          {/* Dropzone */}
          <div
            {...getRootProps()}
            className={`group relative flex flex-col items-center justify-center py-16 px-6 border-2 border-dashed rounded-2xl cursor-pointer transition-all duration-200 ease-in-out ${
              isDragActive 
          ...
          {/* Error Message */}
          {error && (
            <div className="mt-6 p-4 bg-rose-50 rounded-2xl border border-rose-100 flex items-start space-x-3">
          ...
          <div className="bg-white rounded-3xl shadow-xl ring-1 ring-slate-900/5 overflow-hidden animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border-b border-slate-100">
              ...
              <div className="p-8 md:p-10 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-slate-100 bg-slate-50/50">
                ...
                <h3 className="mt-6 text-sm font-bold tracking-widest text-slate-400 uppercase">ATS Match Score</h3>
              </div>
